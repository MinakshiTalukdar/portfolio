...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">I'm Minakshi.</h2>;
  const three = (
  ...
  const four = (
    <>
      <p>
        ...
        , focusing on digital transformation and innovative solutions that enhance user experiences.
      </p>
    </>
  );
  const five = (
    <a
      ...
      href="https://medium.com/mavennet/agile-methodology-3f8b2f18d508"
      target="_blank"
      rel="noreferrer">
      Check out my Blog!
    </a>
